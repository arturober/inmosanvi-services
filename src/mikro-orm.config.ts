...
const mikroOrmConfig: Options = {
  ...
  dbName: 'realstate.sqlite', // Nombre de la base de datos SQLite
  ...
  seeder: {
    path: './dist/seeders', // Directorio de los seeders compilados
    pathTs: './src/seeders', // Directorio de los seeders en TypeScript
