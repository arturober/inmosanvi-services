...
export class UserController {
  ...
  @Post('me/favourites/:propertyId')
  @HttpCode(204)
  async addPropertyFavourites(
    @AuthUser() authUser: User,
    @Param('propertyId', ParseIntPipe) propertyId: number,
  ) {
    await this.usersService.addPropertyFavourites(authUser, propertyId);
  }
  ...
  async removePropertyFavourites(
    ...
    await this.usersService.removePropertyFavourites(authUser, propertyId);
  }

  @Get('me/favourites')
  async getFavouriteProperties(@AuthUser() authUser: User) {
    return {
      properties: await this.usersService.getFavouriteProperties(authUser.id),
    };
  }
}
